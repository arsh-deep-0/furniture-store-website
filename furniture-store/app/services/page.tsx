                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8">
                        <div className="flex flex-col rounded-lg shadow-sm bg-white overflow-hidden dark:bg-gray-800">
                            <a href="#" className="block relative group">
                                ...
                                <img src="https://cdn.tailkit.com/media/placeholders/photo-73F4pKoUkM0-800x600.jpg" alt="Featublue Image of blog post" />
                            </a>
                            <div className="p-6">
                        ...
                        <div className="flex flex-col rounded-lg shadow-sm bg-white overflow-hidden dark:bg-gray-800">
                            <a href="#" className="block relative group">
                                ...
                                <img src="https://cdn.tailkit.com/media/placeholders/photo-phIFdC6lA4E-800x600.jpg" alt="Featublue Image of blog post" />
                            </a>
                            <div className="p-6">
                        ...
                        <div className="flex flex-col rounded-lg shadow-sm bg-white overflow-hidden dark:bg-gray-800">
                            <a href="#" className="block relative group">
                                ...
                                <img src="https://cdn.tailkit.com/media/placeholders/photo-T7K4aEPoGGk-800x600.jpg" alt="Featublue Image of blog post" />
                            </a>
                            <div className="p-6">

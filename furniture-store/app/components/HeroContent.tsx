...
">
            ...
            <TextTypingEffect />
            <h2 className="h2 text-sm font-frank leading-relaxed font-medium sm:my-0 lg:w-2/3 mx-auto text-gray-300">

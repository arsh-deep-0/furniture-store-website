        ...
        <div className="scr-container container xl:max-w-7xl mx-auto px-4 py-4 lg:px-8">
          <div  className="scroller overflow-hidden flex gap-24 text-center">
            <div className="flex logo  items-center justify-center mx-8">
              <a href="#" className="py-2 inline-flex items-center space-x-2 text-lg transition text-gray-100 font-semibold opacity-75 grayscale hover:grayscale-0 hover:opacity-100 active:opacity-50 dark:text-gray-100">

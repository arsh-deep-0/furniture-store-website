  ...
  useEffect(() => {
    ...
    const m2=(element:any )=>{
      tl.fromTo(element,{
        ...
        x: -containerWidth, // Move the element to the leftmost side
        duration: 24, // Animation duration in seconds
        ease: 'linear',
        repeat:-1,
      ...
      tl.fromTo(element1,{
        ...
        x: -2*containerWidth, // Move the element to the leftmost side
        duration: 24, // Animation duration in seconds
        ease: 'linear',
        repeat:-1,
        // Linear easing for constant speed

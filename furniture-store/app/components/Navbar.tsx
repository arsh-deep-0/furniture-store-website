...
function Navbar() {
  ...
  return (
    <>
    {/* Main Header */}
    <header id="page-header" className="sticky  flex justify-center items-center py-8">
              {/* Main Header Content */}
              <div className="navbar w-full py-1  flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 container xl:max-w-7xl mx-0  lg:px-8">
                <div>

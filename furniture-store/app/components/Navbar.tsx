      ...
      <div id="page-header" className=" relative   flex justify-center items-center py-8">
        ...
        <div className="navbar w-full  py-1 px-5  flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 container xl:max-w-7xl mx-0  lg:px-32">
          <div className='flex justify-between items-center'>
            <a href="#" className=" rounded-md px-2 py-1 group inline-flex  items-center space-x-2 font-bold text-lg tracking-wide text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300">
              ...
              <span className=' sm:font-l-sm uppercase lg:text-lg md:text-lg  lg:font-l'>Universal Custom Kitchens</span>
            </a>
          ...
          <div className="navbar-modal flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-10 ">
            <nav className=" flex flex-col items-center justify-center  lg:space-y-0 lg:flex-row lg:items-center lg:justify-center lg:space-x-3 md:flex-row md:space-x-6 sm:flex-col sm:space-y-6">
              <a href="/" className={`hidden text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>Home</span>
              </a>

              <a href="/" className={` text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>Home</span>
              </a>

              <a href="/about" className={` text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>About</span>
              </a>

              <a href="/gallery" className={` text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>Gallery</span>
              </a>

              <a href="/services" className={` text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>Services</span>
              </a>

              <a href="/contact" className={` text-lg  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
                <span>ContactUs</span>
              </a>
        ...
        {navbarVisible&&<div className="navbar-modal-2 flex flex-col text-center md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-10 ">
          ...
          <nav className=" flex flex-col items-center justify-center  lg:space-y-0 lg:flex-row lg:items-center lg:justify-center lg:space-x-3 md:flex-row md:space-x-6 sm:flex-col sm:space-y-6">
            <a href="/" className={`hidden text-xl  text-gray-900 hover:text-blue-600 dark:text-gray-100 dark:hover:text-blue-400 `}>
              <span className='new-nav font-frank text-xl'>Home</span>
            </a>

          ...
          <div className="relative flex flex-col lg:flex-row space-y-16 lg:space-y-0 text-center lg:text-left container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
            <div className="lg:w-1/2  lg:flex  lg:items-center">
              <div className="relative mx-5 ">
                <div className="absolute top-0 left-0 w-40 h-40 lg:w-72 lg:h-72 bg-transparent border border-blue-200 rounded-full -mt-16 -ml-20 dark:border-blue-900" />
                <div className="absolute top-0 left-0 w-40 h-40 lg:w-72 lg:h-72 bg-transparent border border-blue-100 rounded-full -mt-20 -ml-14 dark:border-blue-950" />
                <div className="absolute bottom-0 right-0 w-40 h-40 lg:w-72 lg:h-72 bg-transparent border border-blue-200 rounded-full -mb-16 -mr-20 dark:border-blue-900" />
                <div className="absolute bottom-0 right-0 w-40 h-40 lg:w-72 lg:h-72 bg-transparent border border-blue-100 rounded-full -mb-20 -mr-14 dark:border-blue-950" />
                ...
                <img src="https://dndkitchencabinets.com/wp-content/uploads/2022/06/About2_03.jpg" className="relative rounded-lg mx-auto shadow-lg" alt="Hero Image" />
              </div>
            </div>

            <div className="lg:w-1/2 lg:flex lg:items-center lg:pl-20">
              <div>
                ...
                <h1 className="text-4xl font-black text-black mb-4 dark:text-white">
                  About <span className="text-blue-600 dark:text-blue-500">DND Kitchen</span> Cabinets
                </h1>
                <h2 className="text-lg leading-relaxed font-medium text-gray-700 dark:text-gray-300">
                  Located in Northeast Brampton, DND Kitchen Cabinets specializes in designing and manufacturing custom-built high-quality cabinets for all kinds of spaces be it residential or commercial. We focus on small details to create a big picture. We are a Brampton kitchen renovations company that offers a wide variety of quality finishes, styles, and textures that tailor your home to fit your style. Functionality is key, and we are experts in redesigning your space to fulfill your current needs requirements.
                  <br />
                  <br />
          ...
          <div className="relative flex flex-col lg:flex-row space-y-16 lg:space-y-0 text-center lg:text-left container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
            <div className="lg:w-1/2 lg:flex lg:items-center">
              <div>
                ...
                <h1 className="text-4xl font-black text-black mb-4 dark:text-white">
                  DND Kitchen Cabinets
                </h1>
                <h2 className="text-lg leading-relaxed font-medium text-gray-700 dark:text-gray-300">
                  Located in Northeast Brampton, DND Kitchen Cabinets specializes in designing and manufacturing custom-built high-quality cabinets for all kinds of spaces be it residential or commercial. We focus on small details to create a big picture. We are a Brampton kitchen renovation company that offers a wide variety of quality finishes, styles, and textures that tailor your home to fit your style. Functionality is key, and we are experts in redesigning your space to fulfill your current needs requirements.
                  <br />
                  <br />
            ...
            <div className="lg:w-1/2 lg:ml-16 lg:flex lg:justify-center lg:items-center">
              <div className="relative mx-5">
                ...
                <div className="absolute inset-0 rounded-xl -m-6 -rotate-2 bg-gray-200 dark:bg-gray-800" />
                <div className="absolute inset-0 rounded-xl -m-6 rotate-1 bg-blue-800 bg-opacity-75 shadow-inner dark:bg-blue-900 dark:bg-opacity-75" />
                <img src="https://dndkitchencabinets.com/wp-content/uploads/2022/06/About2_01.jpg" className="relative rounded-lg mx-auto shadow-lg" alt="Hero Image" />
              </div>
            </div>
          </div>
          {/* END Hero Content */}
